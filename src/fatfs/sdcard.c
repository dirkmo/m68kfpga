...
#define CHIPSELECT SPI_CTRL_MASK_CS1

#define CS_LOW()  SPI_CTRL = (CHIPSELECT | SPI_CTRL_MASK_CLKDIV4)	/* MMC CS = L */
#define CS_HIGH() SPI_CTRL = 0	/* MMC CS = H */

#define FCLK_SLOW() SPI_CTRL = (CHIPSELECT | SPI_CTRL_MASK_CLKDIV8)
#define FCLK_FAST() SPI_CTRL = (CHIPSELECT  | SPI_CTRL_MASK_CLKDIV4)
